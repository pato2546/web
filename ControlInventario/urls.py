...
urlpatterns = [
    ...
    path('carro/stock_actualizar/', views.stock_db_actualizar, name='stock_db_actualizar'),
    path('carro/eliminar/', views.eliminar_item_carro, name='eliminar_item_carro'),
    path('carro/actualizar_cantidad/', views.actualizar_cantidad_carro, name='actualizar_cantidad_carro'),
    path('carro/confirmar/', views.confirmar_pedido, name='confirmar_pedido'),
